...
Product {
    ...
    property string includePath:     "include/app_example/"
    property string docPath:         "share/doc/app_example"
    property string rPluginPath:     "../lib/app_example/plugins/"

    Properties {
        condition: qbs.targetOS.contains("linux")
        property string rLibraryPath:     "../lib/app_example"
        property string rLibraryTestPath: "../../../lib/app_example"
    }
    Properties {
